...
export default function PersistentDrawerLeft() {
	...
	const [color, setColor] = React.useState('#3D3D93');
	const [colors, setColors] = React.useState(['#3D3D93', 'purple']);
			...
			>
				...
				<div className={styles.drawerWrapper}>
					...
					<div className={styles.btnGroup}>
						<Button variant='contained' sx={{ background: '#f50057' }}>clear palette</Button>
						<Button variant='contained' sx={{ background: '#673ab7' }}>random color</Button>
					</div>
